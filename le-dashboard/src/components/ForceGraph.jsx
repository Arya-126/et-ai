...
export default function ForceGraph({ graph, detected, selectedRing, onPick, width, height }) {
  ...
  // react-force-graph mutates node objects with x/y; clone defensively per load.
  const data = useMemo(() => {
  ...
  // When a ring is selected, fly to just that ring's nodes — the dramatic
  // "this operation lights up" moment.
  useEffect(() => {
