  ...
  return (
    <div className="h-full overflow-y-auto bg-slate-950 text-slate-200">
      <div className="max-w-5xl mx-auto px-6 py-8">
        <div className="text-cyan-400 text-xs font-bold tracking-[0.2em] uppercase">Call Guard</div>
        <h1 className="mt-1 text-3xl font-extrabold text-white">Screen calls from unsaved numbers</h1>
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-6">
          {/* incoming call card */}
          <div className="rounded-3xl bg-gradient-to-b from-slate-800 to-slate-900 border border-slate-700 p-6 text-center">
            <div className="text-xs text-slate-400">Incoming call</div>
            <div className="mt-4 w-20 h-20 mx-auto rounded-full bg-slate-700 flex items-center justify-center text-3xl animate-pulse">
              {call.saved ? "👤" : "❓"}
            </div>
            ...
            <div className="mt-5 flex gap-3 justify-center">
              <button onClick={screen} disabled={busy}
                      className="rounded-full bg-cyan-500 hover:bg-cyan-400 text-slate-900 font-bold px-5 py-2 disabled:opacity-50">
