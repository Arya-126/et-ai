...
export default function Shield() {
  ...
  async function send(text) {
    ...
    try {
      ...
      setMessages((m) => [
        ...m,
        { kind: "verdict", report: { verdict: "SUSPICIOUS", advice: "Couldn't reach the Fraud Shield backend. Is the API running on :8000?", red_flags: [] } },
      ]);
    } finally {
      setBusy(false);
    }
  ...
  return (
    <div className="h-full flex items-center justify-center bg-slate-200 p-4">
      <div className="w-full max-w-md h-[85vh] flex flex-col rounded-xl overflow-hidden shadow-2xl bg-white">
